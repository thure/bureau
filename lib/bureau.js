...
(function ($) {
  ...
  $.fn.bureau = function (configuration) {
    ...
    var animate = function (showHide, property, duration, easing) {
      var props;
      if(property === 'height'){
        props = {
      ...
      if(property === 'width'){
        props = {
          'marginLeft': $(this).css('margin-top'),
          'marginRight': $(this).css('margin-bottom'),
          'paddingLeft': $(this).css('padding-top'),
          'paddingRight': $(this).css('padding-bottom'),
